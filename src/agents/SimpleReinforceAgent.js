...
SimpleReinforceAgent.prototype = {
  reset: function() {
    ...
    this.actorNet = {};
    this.actorNet.W1 = new Recurrent.RandMat(this.nh, this.ns, 0, 0.01);
    this.actorNet.b1 = new Recurrent.Mat(this.nh, 1, 0, 0.01);
    this.actorNet.W2 = new Recurrent.RandMat(this.na, this.nh, 0, 0.1);
    this.actorNet.b2 = new Recurrent.Mat(this.na, 1, 0, 0.01);
    this.actorOutputs = [];
    this.actorGraphs = [];
    ...
    this.baselineNet = {};
    this.baselineNet.W1 = new Recurrent.RandMat(this.nhb, this.ns, 0, 0.01);
    this.baselineNet.b1 = new Recurrent.Mat(this.nhb, 1, 0, 0.01);
    this.baselineNet.W2 = new Recurrent.RandMat(this.na, this.nhb, 0, 0.01);
    this.baselineNet.b2 = new Recurrent.Mat(this.na, 1, 0, 0.01);
  ...
  forwardActor: function(s, needs_backprop) {
    ...
    var G = new Recurrent.Graph(needs_backprop);
  ...
  act: function(slist) {
    ...
    var s = new Recurrent.Mat(this.ns, 1);
    s.setFrom(slist);
    ...
    var a = Recurrent.copyMat(amat);
    var gaussVar = 0.02;
    a.w[0] = Recurrent.randn(0, gaussVar);
    a.w[1] = Recurrent.randn(0, gaussVar);
  ...
  learn: function(r1) {
    ...
    if(n >= nup) {
      ...
      Recurrent.updateNet(this.actorNet, this.alpha); // update actor network
      Recurrent.updateNet(this.baselineNet, this.beta); // update baseline network
